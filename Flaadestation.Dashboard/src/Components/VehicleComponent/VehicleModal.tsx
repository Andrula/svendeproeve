  ...
  useEffect(() => {
    if (vehicle) {
      setFormData({
        ...
        note: vehicle.data.note,
        defaultStorageId: vehicle.data.defaultStorage?.storageId || ''
      });
    } else {
      setFormData({
        model: '',
        ...
        <div className="modal-content shadow-lg" style={{ backgroundColor: 'white', border: '1px solid #dee2e6' }}>
          ...
          <form onSubmit={handleSubmit}>
            <div className="modal-body" style={{ backgroundColor: 'white', padding: '24px' }}>
              <div className="mb-3">
                <label htmlFor="model" className="form-label text-dark">Model *</label>
                <input
                  type="text"
              ...
              <div className="mb-3">
                <label htmlFor="licensePlate" className="form-label text-dark">Nummerplade</label>
                <input
                  type="text"
                  className="form-control"
                  id="licensePlate"
